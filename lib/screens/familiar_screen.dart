...
class _FamiliarScreenState extends State<FamiliarScreen> {
  ...
  Future<void> _loadTasks() async {
    final tasks = await _db.getTasksByCategory('Familiar');
  ...
  void _showTaskDialog({Task? task}) {
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        title: Text(task == null ? 'Nueva Tarea Familiar' : 'Editar Tarea'),
        content: Column(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Familiar')),
      body: _tasks.isEmpty
          ? EmptyState(
              message: 'Todavía no tienes tareas familiares.',
